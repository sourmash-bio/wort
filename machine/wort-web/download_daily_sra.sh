...
output_metatranscriptomics=outputs_metatranscriptomics/${day_plain}.csv
...
docker-compose exec -T web flask shell -c "%run -i machine/wort-web/daily-sra-biopython.py --metagenomes machine/wort-web/${output_metagenomes} --genomes machine/wort-web/${output_genomes} --metatranscriptomics machine/wort-web/${output_metatranscriptomics}"
