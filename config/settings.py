...
SIG_STORAGE_ACCESS_KEY_ID = os.environ["SIG_STORAGE_ACCESS_KEY_ID"]
SIG_STORAGE_SECRET_ACCESS_KEY = os.environ["SIG_STORAGE_SECRET_ACCESS_KEY"]
SIG_STORAGE_ENDPOINT_URL = os.environ["SIG_STORAGE_ENDPOINT_URL"]
